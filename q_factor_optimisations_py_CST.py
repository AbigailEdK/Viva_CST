...
#                         print("tree_item_comp2] starts with Q_int and tree_item does not end with Q_int")
#                         yield tree_item
# # 2.
...
#             mod = prj.model3d
#             for item_path in get_1d_gamma_paths(mod):
...
#                 print(f"Propagation constant at {frequencies[frequency_index]:.2f} GHz: {propagation_constant_at_30ghz}")
